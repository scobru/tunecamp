...
| Profile | Mode | Store | Social | Network | Live | Samples | Collab | Public registration | Listener self-publish |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
- **Music Curator** — playlists and discovery: social feed on, listeners may self-publish.
- **Web Radio / Streamer** — live broadcasting: the Live module on, store off.
