...
| Auto Mix / DJ Mode | **🧪 LAB / not implemented** | Design proposal only; see [auto-mix-dj.md](auto-mix-dj.md). Tracked under the experimental [LAB](index.md#-lab--experimental--proposals) section. |
