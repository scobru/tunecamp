...
export type ModuleFlag = 'hideLive' | 'hideStore' | 'hideSocial' | 'hideNetwork' | 'hideDig' | 'hideSamples' | 'hideCollab' | 'hideLab';
    ...
    try {
      ...
      set({
        ...
        flags: {
          ...
          hideCollab: truthy(s.hideCollab),
          hideLab: truthy(s.hideLab),
        },
      });
    } catch (e) {
