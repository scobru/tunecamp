...
import { RefreshCw, Trash2, ExternalLink, Globe, Rss } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="opacity-70 text-sm mt-1 font-medium">
                    Choose which external sources this instance follows. Discovered content appears in the Network page for everyone on this server. These follows are sent by the <b>instance actor</b> (@site@{window.location.hostname}).
                </p>
            </div>
            ...
            <div className="card card-m3 bg-base-200/30">
                <div className="card-body p-6">
                    ...
                    <p className="text-sm opacity-70 mb-4 font-medium">
                        Follow other TuneCamp instances, Funkwhale channels or ActivityPub Relays.
                    </p>
