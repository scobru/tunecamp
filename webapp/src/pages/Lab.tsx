...
import { CATEGORY_LABELS, CATEGORY_COLORS } from '../data/labApps';
      ...
      <div className="max-w-5xl mx-auto">
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {apps.map((app) => {
              const CategoryIcon = CATEGORY_ICONS[app.category] ?? Music2;
              const categoryLabel = CATEGORY_LABELS[app.category as keyof typeof CATEGORY_LABELS] ?? app.category;
              const categoryColor = CATEGORY_COLORS[app.category as keyof typeof CATEGORY_COLORS] ?? 'badge-neutral';
              return (
                <div
                  key={app.id}
                ...
                >
                  <div className="card-body p-6 flex flex-col gap-4">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`badge badge-sm font-bold ${categoryColor}`}>
                        {categoryLabel}
                      </span>
                    </div>
