...
- Route/module visibility flags (`hideLive`, `hideStore`, `hideSocial`, `hideNetwork`, `hideDig`, `hideDj`) come from `useSiteSettingsStore` and are enforced by `ModuleGuard` — don't hardcode visibility checks elsewhere.
