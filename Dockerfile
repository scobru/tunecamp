...
# Top-level ARGs passed by CapRover / Docker
...
ENV TUNECAMP_PUBLIC_URL=$TUNECAMP_PUBLIC_URL
ENV TUNECAMP_RPC_URL=$TUNECAMP_RPC_URL
ENV TUNECAMP_CURRENCY_CONTRACT=$TUNECAMP_CURRENCY_CONTRACT
ENV DISCOGS_TOKEN=$DISCOGS_TOKEN
ENV TUNECAMP_DOWNLOAD_DIR=$TUNECAMP_DOWNLOAD_DIR
ENV TELEGRAM_BOT_TOKEN=$TELEGRAM_BOT_TOKEN
ENV TELEGRAM_MASTER_ID=$TELEGRAM_MASTER_ID
ENV OPENROUTER_API_KEY=$OPENROUTER_API_KEY
ENV OPENROUTER_MODEL=$OPENROUTER_MODEL
ENV TUNECAMP_GDRIVE_CLIENT_ID=$TUNECAMP_GDRIVE_CLIENT_ID
ENV TUNECAMP_GDRIVE_CLIENT_SECRET=$TUNECAMP_GDRIVE_CLIENT_SECRET
ENV STRIPE_SECRET_KEY=$STRIPE_SECRET_KEY
ENV STRIPE_WEBHOOK_SECRET=$STRIPE_WEBHOOK_SECRET
ENV STRIPE_ONRAMP_SECRET_KEY=$STRIPE_ONRAMP_SECRET_KEY
