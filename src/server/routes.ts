...
export function registerRoutes(
	...
	app.use(
		...
		createUploadRoutes(container),
	);
	app.use(
		"/api/admin/backup",
		authMiddleware.requireAdmin,
		createBackupRoutes(container, () => {
			process.exit(0);
		}),
	);
	...
	app.use(
		...
		createPaymentsRoutes(container),
	);
	...
	app.use(
		"/api/catalog",
		authMiddleware.optionalAuth,
		createCatalogRoutes(container),
	);
	app.use(
		"/api/artists",
		authMiddleware.optionalAuth,
		createArtistsRoutes(container),
	);
	app.use(
		"/api/albums",
		authMiddleware.optionalAuth,
		createAlbumsRoutes(container),
	);
	app.use(
		"/api/tracks",
		authMiddleware.optionalAuth,
	...
	app.use(
		...
		createBrowserRoutes(container),
	);
	app.use(
		"/api/metadata",
		authMiddleware.requireRootAdmin,
		createMetadataRoutes(container),
	);
	...
	app.use(
		"/api/lifecycle",
		authMiddleware.requireUser,
		createLifecycleRoutes(container),
	);
	app.use("/api/ap", createActivityPubRoutes(container));
	app.use(
		"/api/account",
		authMiddleware.requireUser,
		createAccountMigrationRoutes(container),
	);
	app.use("/api/proxy", createProxyRoutes(container));
	app.use(
		"/api/admin/tasks",
		authMiddleware.requireAdmin,
		createTaskRoutes(container),
	);
	app.use(
		"/api/search",
		authMiddleware.optionalAuth,
